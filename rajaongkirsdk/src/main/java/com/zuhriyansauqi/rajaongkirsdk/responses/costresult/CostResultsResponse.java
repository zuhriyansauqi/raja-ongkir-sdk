...
public class CostResultsResponse extends GeneralResponse {

    private List<CostResultObject> costResults;

    public CostResultsResponse(int statusCode, String statusDescription, List<CostResultObject> costResults) {
